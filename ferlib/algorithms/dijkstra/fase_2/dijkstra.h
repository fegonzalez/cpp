...
est. datos (i.e. adj en Fase2)
  ...
  */
  ...
  //  class DijkstraFase2: public Dijkstra // see waring above
  class DijkstraFase2
  {
  public:
	...
	@return The distance from start to all the other vertex.
    */
    DijkstraSolution shortest_path(const Fase2Graph &graph, 
				   const VertexId &start,
	...
	@return The distance from start to all the other vertex.
    */
    // void shortest_paths(const Fase2Graph &graph, const VertexId &start);
